...
- (void)dealloc
{
    ...
    safeReleaseCocoaObj(_fillAnimation);
    safeReleaseCocoaObj(_clearAnimation);
    safeReleaseCocoaObj(_colorAnimation);
    safeReleaseCocoaObj(_drainAnimation);
    safeReleaseCocoaObj(_animationLayer);
